...
_TASK_KEYWORDS: dict[TaskType, dict[str, list[str]]] = {
    ...
    TaskType.MULTIMODAL: {
        ...
        "secondary": ["image", "photo", "picture", "audio", "video", "transcribe", "ocr", "vision"],
    },
    TaskType.REASONING: {
        "primary": [
            "pros and cons",
        ...
        "secondary": ["why", "should i", "versus", "vs", "argument", "logic", "validate", "review"],
    },
    TaskType.THINKING: {
        "primary": [
            "system design",
    ...
    TaskType.DOC_CREATION: {
        ...
        "secondary": ["document", "readme", "guide", "manual", "summarize", "describe", "explain", "comment"],
    },
}

_NEGATIVE_KEYWORDS: dict[TaskType, list[str]] = {
    TaskType.CODE_CREATION: ["explain", "what is", "tell me about", "how does", "describe what"],
